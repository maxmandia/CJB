...
function Motion() {
  ...
  return (
    <div className="motion-container">
      {showNav && <SideBar />}
      <Header isBlack={true} />
      {/* <div className="motion-header-container">
        <img
          className="motion-header"
          alt="motion-header"
          src="https://firebasestorage.googleapis.com/v0/b/cullen-blanchfield.appspot.com/o/motion-header.jpeg?alt=media&token=f61bf64f-7385-4c46-bf59-d8046119ee06"
        />
      </div>
      <div className="motion-header-text-container">
        <h2 id="motion-text">Life in</h2>
        <h1 id="motion-text-2">Motion</h1>
      </div> */}
